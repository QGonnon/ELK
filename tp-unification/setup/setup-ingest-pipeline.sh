...
curl -X PUT "http://elasticsearch:9200/_ingest/pipeline/unified-logs-pipeline" -H 'Content-Type: application/json' -d '
{
...
curl -X PUT "http://elasticsearch:9200/_index_template/unified-logs-template" -H 'Content-Type: application/json' -d '
{
